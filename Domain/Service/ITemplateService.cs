...
public interface ITemplateService
{
  ...
  Task<Result<IEnumerable<TemplateVersionPrincipal>>> SearchVersion(string username, string name,
    TemplateVersionSearch version);

  Task<Result<IEnumerable<TemplateVersionPrincipal>>> SearchVersion(string userId, Guid id,
    TemplateVersionSearch version);
  ...
  Task<Result<TemplateVersionPrincipal?>> CreateVersion(string username, string name, TemplateVersionRecord record,
    TemplateVersionProperty property, IEnumerable<ProcessorVersionRef> processors,
