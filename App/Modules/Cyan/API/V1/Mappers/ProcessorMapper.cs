...
public static class ProcessorMapper
{
  public static (
    ProcessorRecord,
    ProcessorMetadata,
    ProcessorVersionRecord,
    ProcessorVersionProperty
  ) ToDomain(this PushProcessorReq req) =>
    (
  ...
  public static ProcessorInfoResp ToResp(this ProcessorInfo info) =>
  ...
  public static ProcessorResp ToResp(this Processor processor) =>
    new(
      processor.Principal.ToResp(),
      processor.Info.ToResp(),
      processor.User.ToResp(),
...
{
  public static (ProcessorVersionProperty, ProcessorVersionRecord) ToDomain(
    this CreateProcessorVersionReq req
  ) =>
    (
      new ProcessorVersionProperty
      {
