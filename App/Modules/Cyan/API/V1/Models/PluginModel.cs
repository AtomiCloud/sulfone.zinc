...
public record PluginInfoResp(uint Downloads, uint Dependencies, uint Stars);

public record PluginResp(
  PluginPrincipalResp Principal,
  PluginInfoResp Info,
