...
public record CreateProcessorReq(
  string Name,
  string Project,
  string Source,
  string Email,
...
public record UpdateProcessorReq(
  string Project,
  string Source,
  string Email,
  string[] Tags,
...
public record ProcessorInfoResp(uint Downloads, uint Dependencies, uint Stars);

public record ProcessorResp(
  ProcessorPrincipalResp Principal,
  ProcessorInfoResp Info,
