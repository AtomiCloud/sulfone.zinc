...
public record CreatePluginVersionReq(string Description, string DockerReference, string DockerTag);
...
public record PluginVersionResp(PluginVersionPrincipalResp Principal, PluginPrincipalResp Plugin);
