...
namespace App.Migrations
{
    ...
    [Migration("20260324081346_AddPresetAnswersToTemplateTemplateVersions")]
    partial class AddPresetAnswersToTemplateTemplateVersions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("App.Modules.Cyan.Data.Models.ResolverData", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("App.Modules.Cyan.Data.Models.ResolverLikeData", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("UserId", "ResolverId")
                        .IsUnique();

                    b.ToTable("ResolverLikes");
                });

            modelBuilder.Entity("App.Modules.Cyan.Data.Models.ResolverVersionData", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("App.Modules.Cyan.Data.Models.TemplateResolverVersionData", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("App.Modules.Cyan.Data.Models.TemplateTemplateVersionData", b =>
                {
                    ...
                    b.Property<string>("PresetAnswers")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("App.Modules.Cyan.Data.Models.ResolverLikeData", b =>
                {
                    b.HasOne("App.Modules.Cyan.Data.Models.ResolverData", "Resolver")
                        .WithMany("Likes")
            ...
            modelBuilder.Entity("App.Modules.Cyan.Data.Models.TemplateResolverVersionData", b =>
                {
                    b.HasOne("App.Modules.Cyan.Data.Models.ResolverVersionData", "Resolver")
                        .WithMany("Templates")
                        .HasForeignKey("ResolverId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
