...
namespace App.Migrations
{
  ...
  public partial class DomainRegistryEntities : Migration
  {
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
      ...
      migrationBuilder
        .CreateIndex(name: "IX_Plugins_SearchVector", table: "Plugins", column: "SearchVector")
      ...
      migrationBuilder
        .CreateIndex(name: "IX_Templates_SearchVector", table: "Templates", column: "SearchVector")
        .Annotation("Npgsql:IndexMethod", "GIN");
    ...
    {
      migrationBuilder.DropTable(name: "PluginLikes");

      migrationBuilder.DropTable(name: "ProcessorLikes");

      migrationBuilder.DropTable(name: "TemplateLikes");

      migrationBuilder.DropTable(name: "TemplatePluginVersions");

      migrationBuilder.DropTable(name: "TemplateProcessorVersions");

      migrationBuilder.DropTable(name: "PluginVersions");

      migrationBuilder.DropTable(name: "ProcessorVersions");

      migrationBuilder.DropTable(name: "TemplateVersions");

      migrationBuilder.DropTable(name: "Plugins");

      migrationBuilder.DropTable(name: "Processors");
