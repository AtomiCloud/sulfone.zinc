...
| ----------- | ------------------------------------------------ | -------------------------------- |
| Search      | `GET /api/v1/processor`                          | `ProcessorController.cs:37-48`   |
| Get by ID   | `GET /api/v1/processor/id/{userId}/{id:guid}`    | `ProcessorController.cs:50-58`   |
| Get by slug | `GET /api/v1/processor/slug/{username}/{name}`   | `ProcessorController.cs:60-68`   |
| Create      | `POST /api/v1/processor/id/{userId}`             | `ProcessorController.cs:70-90`   |
| Update      | `PUT /api/v1/processor/id/{userId}/{id}`         | `ProcessorController.cs:92-116`  |
| Delete      | `DELETE /api/v1/processor/id/{userId}/{id:guid}` | `ProcessorController.cs:148-160` |
...
| Update non-existent processor | 404 Not Found    |
| Delete non-existent processor | 404 Not Found    |
...
<!--
NOTE: The processor like endpoint documented here uses the slug path with likerId and true/false path segment.
...
| --------- | -------------------------------------------------------------------- | ------------------ |
| Like      | `POST /api/v1/processor/slug/{username}/{name}/like/{likerId}/true`  | Like a processor   |
| Unlike    | `POST /api/v1/processor/slug/{username}/{name}/like/{likerId}/false` | Unlike a processor |
